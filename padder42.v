...
//
// Create Date: 05/13/2022 01:55:01 PM
// Design Name:
// Module Name: padder42
// Project Name:
// Target Devices:
// Tool Versions:
// Description: 42-bit Integer Prefix Adder with Carry In/Carry Out
//
...
module padder42(A, B, Cin, S, Cout);
  parameter N = 42;
  input [N-1:0] A, B;
  input Cin;
  output [N-1:0] S;
  ...
  assign Cout = (\G40:-1 & A[41]) | (\G40:-1 & B[41]) | (A[41] & B[41]);
